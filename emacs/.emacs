...
(custom-set-variables
 ...
 '(package-selected-packages
   '(ess helm elpy company-jedi ein pylint flycheck-pycheckers flycheck-pyflakes rust-mode elfeed olivetti-mode notmuch olivetti futhark-mode dracula-theme forge gdscript-mode lsp-mode lsp-ui lsp-java java-snippets tuareg flycheck cwl-mode snakemake-mode dockerfile-mode rtags-xref org-bullets scala-mode zenburn-theme yasnippet-snippets wrap-region use-package tramp solarized-theme smex rainbow-mode rainbow-delimiters python-docstring python pydoc projectile pdf-tools paredit org multiple-cursors move-text moe-theme modus-vivendi-theme modus-operandi-theme magit kosmos-theme kaolin-themes jazz-theme ido-completing-read+ hindent haskell-tab-indent haskell-snippets gruvbox-theme gruber-darker-theme git-timemachine gh-md ggtags frame-local eshell-syntax-highlighting emmet-mode embrace djvu direx-grep dash-functional company-ycmd company-posframe company-ghci company-ctags company-c-headers company-auctex clang-capf cl-libify avy auctex-latexmk agda2-mode))
